...
namespace Licenta1.Controllers
{
    ...
    public class TestimonialsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,TestID,Data,Descriere,Validat")] Testimonial testimonial)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,TestID,Data,Descriere,Validat")] Testimonial testimonial)
        {
            if (ModelState.IsValid)
            {
